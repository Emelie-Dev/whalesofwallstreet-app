          ...
          <View style={styles.userRow}>
            <View style={styles.avatarWrap}>
              <Image
                ...
                style={[styles.avatar, { backgroundColor: c.secondary }]}
              />
              <View
                style={[
                  styles.onlineDot,
        ...
        {isPortfolioUnavailable ? (
          ...
          >
            <Ionicons
              ...
              color={c.mutedForeground}
            />
            <Text style={[styles.emptyStateTitle, { color: c.foreground }]}>
              Wallet data unavailable
            </Text>
            <Text style={[styles.emptyStateText, { color: c.mutedForeground }]}>
              Connect to the internet and pull to refresh your wallet.
            </Text>
          </View>
        ) : (
          <>
            ...
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                <Text
                  style={[styles.sectionTitle, { color: c.mutedForeground }]}
                >
                  RECENT TRANSACTIONS
                </Text>
                <TouchableOpacity
              ...
              <View
                style={[
                  styles.txCard,
                  { backgroundColor: c.card, borderColor: c.border + "50" },
                  shadows.card,
                ]}
              >
